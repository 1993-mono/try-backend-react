...
- [ ] [Swagger Editor](https://editor.swagger.io/) 열어 오른쪽 UI(미리보기)부터 보기
- [ ] 스프레드시트 한 행 ↔ Swagger 한 endpoint가 같은 정보임을 대응해 보기
- [ ] Try it out으로 호출해 보기 (부장님이 말씀하신 “홈페이지로 전달” 방식)

### 4) Swagger 쓰기

- [ ] 왼쪽 YAML로 todo API 한 개 명세 작성해 보기
